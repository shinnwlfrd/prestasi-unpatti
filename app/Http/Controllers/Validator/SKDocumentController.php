...
use App\Services\Validator\SKDocumentService;
use Illuminate\Http\Request;

class SKDocumentController extends Controller
{
    public function __construct(
        protected SKDocumentService $skDocumentService
    ) {}
    ...
    public function processAssignment(Request $request, SKDocument $sk)
    {
        ...
        $assignedCount = $this->skDocumentService->processBatchAssignment(
            $sk,
            $validated['achievement_ids'],
            auth()->id(),
