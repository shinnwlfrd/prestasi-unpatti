...
@if($activeRoles->count() > 1)
    <div x-data="{ open: false }" class="relative">
        ...
        <button @click="open = !open" type="button"
            class="w-full flex items-center justify-between px-3 py-2 text-sm bg-emerald-50 dark:bg-emerald-900/20 text-emerald-700 dark:text-emerald-300 rounded-lg hover:bg-emerald-100 dark:hover:bg-emerald-900/40 transition-colors mb-2">
                            ...
                            <div class="flex items-center space-x-2">
                                ...
                                <div class="flex-1 min-w-0">
                                    ...
                                    @if($role->level !== 'university')
                                        <p class="text-xs text-gray-500 dark:text-gray-400 truncate">{{ $role->getScopeDescription() }}
                                        </p>
                                    @endif
                                </div>
                            </div>
