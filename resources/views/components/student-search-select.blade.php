    ...
    <div class="relative">
        <div class="relative">
            <input type="text" 
                ...
                class="w-full border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-lg pl-10 pr-10 {{ $error ? 'border-red-500' : '' }}">
        ...
        <!-- Dropdown Results -->
        <div x-show="showDropdown && (students.length > 0 || searchQuery.length >= 2)" 
            x-cloak
                            ...
                            <div class="flex items-center gap-3 flex-1">
                                ...
                                <div class="flex-shrink-0">
                                    <div :class="isSelected(student.student_id) ? 'bg-purple-600 border-purple-600' : 'bg-white dark:bg-gray-700 border-gray-300 dark:border-gray-600'"
                                        ...
                                        <svg x-show="isSelected(student.student_id)" class="w-3 h-3 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div x-show="searchQuery.length < 2 && students.length === 0" 
                ...
                Ketik minimal 2 karakter lalu tekan <kbd class="px-2 py-1 bg-gray-100 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded text-xs font-mono">Enter</kbd> untuk mencari
            </div>
        </div>
    </div>
                    ...
                    <div class="flex items-start justify-between gap-3">
                        <div class="flex items-start gap-3 flex-1">
                            ...
                            <div class="flex-1 min-w-0">
                                <p class="font-semibold text-gray-900 dark:text-white text-sm truncate" x-text="student.name"></p>
                                <div class="flex items-center gap-2 mt-1 text-xs text-gray-600 dark:text-gray-400 flex-wrap">
                                    <span x-text="student.student_id"></span>
                                    <span>•</span>
