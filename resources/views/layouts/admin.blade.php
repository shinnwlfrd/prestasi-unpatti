    ...
    <div class="flex">
        ...
        <aside :class="sidebarOpen ? 'w-64' : 'w-20'" class="fixed h-screen bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 transition-all duration-300 z-30">
            ...
            <nav class="p-4 space-y-2">
                ...
                <a href="{{ route('admin.achievements') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg {{ request()->routeIs('admin.achievements') ? 'bg-purple-100 dark:bg-purple-900/30 text-purple-600 dark:text-purple-400' : 'text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700' }}">
