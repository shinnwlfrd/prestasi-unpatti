...
<head>
    ...
    <title>@yield('title', 'Faculty Panel') - SIMAPRES</title>
        ...
        <aside :class="mobileSidebarOpen ? 'translate-x-0' : '-translate-x-full lg:translate-x-0'"
            ...
            <div
                ...
                <div class="flex items-center gap-3">
                    <div
                        class="w-12 h-12 flex items-center justify-center p-0.5">
            ...
            <nav class="flex-1 p-4 space-y-1.5 overflow-y-auto custom-scrollbar">
                ...
                @if($isOperator)
                    ...
                    <a href="{{ route('validator.pending.index') }}"
                        ...
                        <span class="text-sm">Validasi Prestasi</span>
                    </a>
                @endif
                ...
                <div class="w-full px-4 md:px-6 lg:px-8 flex justify-between items-center">
                    ...
                    <div class="flex items-center gap-2 sm:gap-4">
                        ...
                        <div
                            ...
                            <div
                                class="w-8 h-8 rounded-lg bg-gray-200 dark:bg-gray-600 flex items-center justify-center text-gray-700 dark:text-gray-300 font-bold text-xs ring-2 ring-white dark:ring-gray-800">
