...
<body class="min-h-screen overflow-hidden relative transition-colors duration-300">
    <!-- Animated Background -->
    <div
        class="fixed inset-0 bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500 dark:from-slate-900 dark:via-purple-900 dark:to-slate-900 animate-gradient">
    </div>

    <!-- Floating Shapes -->
    <div class="fixed inset-0 overflow-hidden pointer-events-none">
        <div class="absolute top-1/4 left-1/4 w-72 h-72 bg-white/10 rounded-full blur-3xl animate-float"
            style="animation-delay: 0s;"></div>
        <div class="absolute bottom-1/4 right-1/4 w-96 h-96 bg-purple-300/20 rounded-full blur-3xl animate-float"
            style="animation-delay: 2s;"></div>
        <div class="absolute top-1/2 right-1/3 w-64 h-64 bg-pink-300/10 rounded-full blur-3xl animate-float"
    ...
    <div class="relative min-h-screen flex items-center justify-center p-4">
        <div class="w-full max-w-md">
            <div
                class="glass bg-white/80 dark:bg-slate-800/80 rounded-3xl shadow-2xl p-8 border border-white/20 dark:border-slate-700/50 transform hover:scale-[1.01] transition-transform duration-300">
                <!-- Logo -->
                <div class="text-center mb-8">
                    <div class="relative inline-block">
                        <div
                            class="w-20 h-20 bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500 rounded-2xl mx-auto flex items-center justify-center shadow-xl animate-pulse-soft">
