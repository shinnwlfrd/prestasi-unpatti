...
@section('content')
    <div class="space-y-6 px-4 sm:px-6 lg:px-8">
        ...
        <nav class="flex items-center gap-2 text-sm">
            <a href="{{ route('admin.dashboard') }}" class="text-gray-500 dark:text-gray-400 hover:text-purple-600 dark:hover:text-purple-400 transition-colors">Dashboard</a>
        ...
        <!-- Header Section -->
        <div class="relative overflow-hidden bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-5 sm:p-6 md:p-8 shadow-sm">
            ...
            <div class="relative flex flex-col md:flex-row md:items-center gap-6">
                <div class="flex-shrink-0 w-14 h-14 sm:w-16 sm:h-16 bg-gradient-to-br from-purple-500 to-indigo-600 rounded-xl shadow-lg shadow-purple-200 dark:shadow-none flex items-center justify-center transform hover:scale-105 transition-transform">
        ...
        <form action="{{ route('admin.submit.store') }}" method="POST" enctype="multipart/form-data" 
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm group relative">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <select name="category_id" required
                                class="w-full bg-white dark:bg-gray-700 border-gray-300 dark:border-gray-600 dark:text-white rounded-xl py-4 px-5 text-base font-medium focus:ring-4 focus:ring-purple-500/10 focus:border-purple-500 transition-all shadow-sm @error('category_id') border-red-500 @enderror">
                ...
                <div class="p-4 sm:p-6 space-y-5 sm:space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="event_name" value="{{ old('event_name') }}" required
                            class="w-full bg-white dark:bg-gray-700 border-gray-300 dark:border-gray-600 dark:text-white rounded-xl py-4 px-5 text-base font-medium focus:ring-4 focus:ring-purple-500/10 transition-all shadow-sm @error('event_name') border-red-500 @enderror placeholder:text-gray-400"
                    ...
                    <div>
                        ...
                        <input type="text" name="organizer" value="{{ old('organizer') }}" required
                            class="w-full bg-white dark:bg-gray-700 border-gray-300 dark:border-gray-600 dark:text-white rounded-xl py-4 px-5 text-base font-medium focus:ring-4 focus:ring-purple-500/10 transition-all shadow-sm @error('organizer') border-red-500 @enderror"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-6">
                        <div>
                            ...
                            <div class="relative">
                                <input type="date" name="event_date" value="{{ old('event_date') }}" required
                                    class="w-full bg-white dark:bg-gray-700 border-gray-300 dark:border-gray-600 dark:text-white rounded-xl py-4 px-5 text-base font-medium focus:ring-4 focus:ring-purple-500/10 transition-all shadow-sm @error('event_date') border-red-500 @enderror">
                            </div>
                            @error('event_date')
                                <p class="text-red-500 text-xs mt-1.5 font-medium">{{ $message }}</p>
                            @enderror
                        ...
                        <div>
                            ...
                            <input type="text" name="ranking" value="{{ old('ranking') }}"
                                class="w-full bg-white dark:bg-gray-700 border-gray-300 dark:border-gray-600 dark:text-white rounded-xl py-4 px-5 text-base font-medium focus:ring-4 focus:ring-purple-500/10 transition-all shadow-sm"
                    ...
                    <div>
                        ...
                        <textarea name="description" rows="4"
                            class="w-full bg-white dark:bg-gray-700 border-gray-300 dark:border-gray-600 dark:text-white rounded-xl py-4 px-5 text-base font-medium focus:ring-4 focus:ring-purple-500/10 transition-all shadow-sm placeholder:text-gray-400"
        ...
        <div class="space-y-8">
                        ...
                        <div class="p-4 sm:p-6 grid grid-cols-1 lg:grid-cols-2 gap-6">
                            ...
                            <div class="flex flex-col" x-data="{ 
                                ...
                                <div class="relative mb-4" x-show="allFiles.length < maxFiles">
                                    ...
                                    <div class="bg-white dark:bg-gray-800 border-2 border-dashed border-purple-100 dark:border-purple-800 rounded-xl p-4 text-center hover:border-purple-400 transition-all">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl border border-purple-100 dark:border-purple-900 shadow-xl shadow-purple-500/5 relative">
                ...
                <div class="p-4 sm:p-8 space-y-6 sm:space-y-8">
                    ...
                    <div>
                        <div class="grid grid-cols-2 sm:grid-cols-2 gap-3 sm:gap-6">
                            <label class="relative cursor-pointer group">
                                ...
                                <div class="h-full p-3 sm:p-5 rounded-xl sm:rounded-xl border-2 border-gray-100 dark:border-gray-700 bg-white dark:bg-gray-800 transition-all group-hover:border-amber-200 dark:group-hover:border-gray-600 peer-checked:border-amber-500 peer-checked:bg-amber-50/30 dark:peer-checked:bg-amber-900/10 peer-checked:shadow-lg peer-checked:shadow-amber-500/10 flex flex-col items-center text-center">
                                    <div class="w-10 h-10 sm:w-12 sm:h-12 bg-amber-50 dark:bg-amber-900/30 rounded-xl sm:rounded-xl flex items-center justify-center mb-2 sm:mb-4 transition-colors">
                                ...
                                <div class="absolute inset-0 rounded-xl sm:rounded-xl ring-2 ring-amber-500 opacity-0 scale-105 peer-checked:opacity-100 peer-checked:scale-100 transition-all pointer-events-none"></div>
                            </label>
                            ...
                            <label class="relative cursor-pointer group">
                                ...
                                <div class="h-full p-3 sm:p-5 rounded-xl sm:rounded-xl border-2 border-gray-100 dark:border-gray-700 bg-white dark:bg-gray-800 transition-all group-hover:border-emerald-200 dark:group-hover:border-gray-600 peer-checked:border-emerald-500 peer-checked:bg-emerald-50/30 dark:peer-checked:bg-emerald-900/10 peer-checked:shadow-lg peer-checked:shadow-emerald-500/10 flex flex-col items-center text-center">
                                    <div class="w-10 h-10 sm:w-12 sm:h-12 bg-emerald-50 dark:bg-emerald-900/30 rounded-xl sm:rounded-xl flex items-center justify-center mb-2 sm:mb-4 transition-colors">
                                ...
                                <div class="absolute inset-0 rounded-xl sm:rounded-xl ring-2 ring-emerald-500 opacity-0 scale-105 peer-checked:opacity-100 peer-checked:scale-100 transition-all pointer-events-none"></div>
                            </label>
                    ...
                    <!-- Info Banner -->
                    <div class="p-5 bg-gradient-to-r from-purple-50 to-purple-100/30 dark:from-purple-950/20 dark:to-purple-900/10 rounded-xl border border-purple-100 dark:border-purple-800/50">
            ...
            <div class="sticky bottom-0 sm:bottom-4 z-40 bg-white/95 dark:bg-gray-900/95 backdrop-blur-md px-4 sm:px-8 py-4 rounded-none sm:rounded-xl border-t sm:border border-gray-200 dark:border-gray-700 shadow-2xl flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-4">
                ...
                <div class="flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
                    ...
                    <button type="submit" :disabled="loading"
                        class="flex-1 sm:flex-none w-full px-10 py-3 bg-gradient-to-r from-purple-600 to-indigo-700 hover:from-purple-700 hover:to-indigo-800 active:scale-95 text-white rounded-xl text-sm font-bold shadow-xl shadow-purple-500/20 disabled:opacity-50 disabled:cursor-not-allowed transition-all flex items-center justify-center gap-3 group">
