...
<div class="max-w-7xl mx-auto" x-data="skManagement()">
        ...
        <div class="overflow-x-auto">
            <table class="w-full">
                <thead class="bg-gray-50 dark:bg-gray-700/50 border-b border-gray-200 dark:border-gray-600">
                    <tr>
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Nomor SK</th>
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Judul</th>
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Metode Upload</th>
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Tanggal Terbit</th>
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Penerbit</th>
                        ...
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center justify-center gap-2">
                                    ...
                                    <!-- Assign ke Prestasi -->
                                    <button @click="openAssignModal({{ $sk->id }}, '{{ addslashes($sk->sk_number) }}', '{{ addslashes($sk->title) }}')" 
    ...
    <div x-show="showModal" 
        ...
        <div @click.stop 
            ...
            <!-- Modal Body -->
            <form action="{{ route('admin.sk.store') }}" method="POST" enctype="multipart/form-data" class="p-6 space-y-5">
                @csrf
                ...
                <div>
                    ...
                    <input type="text" 
                           name="sk_number" 
                           value="{{ old('sk_number') }}"
                           placeholder="Contoh: 123/SK/UNPATTI/2024"
                           required
                ...
                <div>
                    ...
                    <input type="text" 
                           name="title" 
                           value="{{ old('title') }}"
                           placeholder="Contoh: SK Prestasi Mahasiswa Semester Genap 2024"
                           required
                    ...
                    <div class="relative">
                        ...
                        <label for="sk_file_input" 
                            ...
                            <div class="flex flex-col items-center justify-center">
                                <svg :class="fileName ? 'text-green-500' : 'text-gray-400'" class="w-10 h-10 mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12"/>
                                </svg>
                                <p :class="fileName ? 'text-green-700 dark:text-green-300 font-medium' : 'text-gray-500 dark:text-gray-400'" class="text-sm">
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="text" 
                               name="issued_by" 
                               value="{{ old('issued_by') }}"
                               placeholder="Contoh: Rektor Universitas Pattimura"
                               required
                ...
                <div>
                    ...
                    <textarea name="notes" 
                              rows="3"
                              placeholder="Catatan tambahan tentang SK ini"
    ...
    <div x-show="showAssignModal" 
        ...
        <div @click.stop 
            ...
            <!-- Modal Header -->
            <div class="bg-gradient-to-r from-purple-50 to-blue-50 dark:from-purple-900/20 dark:to-blue-900/20 border-b border-purple-200 dark:border-purple-800 px-6 py-4">
                <div class="flex items-start justify-between">
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-700 dark:text-gray-300 mt-1" x-text="'SK: ' + selectedSk.number"></p>
            ...
            <div class="flex-1 overflow-y-auto p-6">
                ...
                <div x-show="!loading && achievements.length === 0" class="text-center py-12">
                    ...
                    <p class="text-sm text-gray-400 dark:text-gray-500 mt-1">Tidak ada prestasi dengan status "Menunggu" yang belum memiliki SK</p>
                </div>
                                ...
                                <tr>
                                    <th class="px-4 py-3 text-left w-12">
                                        <input type="checkbox" 
                                               ...
                                               :checked="selectedAchievements.length === filteredAchievements.length && filteredAchievements.length > 0"
                                    ...
                                    <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase">Tanggal Event</th>
                                </tr>
                            </thead>
                            <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                                <template x-for="achievement in filteredAchievements" :key="achievement.sa_id">
                                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                                        <td class="px-4 py-3">
                                            <input type="checkbox" 
                                                   :value="achievement.sa_id"
                                                   @change="toggleAchievement(achievement.sa_id)"
                                                   :checked="selectedAchievements.includes(achievement.sa_id)"
                                                   class="w-4 h-4 text-purple-600 bg-gray-100 border-gray-300 rounded focus:ring-purple-500 dark:bg-gray-700 dark:border-gray-600">
                                        </td>
                                        <td class="px-4 py-3 text-gray-900 dark:text-white font-medium" x-text="achievement.student.nim"></td>
                                        <td class="px-4 py-3 text-gray-900 dark:text-white" x-text="achievement.student.name"></td>
                                        <td class="px-4 py-3 text-gray-900 dark:text-white" x-text="achievement.event_name"></td>
                                        <td class="px-4 py-3 text-gray-600 dark:text-gray-400" x-text="achievement.achievement.category.name"></td>
                                        <td class="px-4 py-3">
                                            <span class="px-2 py-1 text-xs bg-blue-100 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 rounded-full" x-text="achievement.level"></span>
                                        </td>
                                        <td class="px-4 py-3 text-gray-600 dark:text-gray-400" x-text="formatDate(achievement.event_date)"></td>
                                    </tr>
                                </template>
                            </tbody>
                        </table>
            ...
            <!-- Modal Footer -->
            <div x-show="!loading && achievements.length > 0" class="border-t border-gray-200 dark:border-gray-700 p-4 bg-gray-50 dark:bg-gray-700/50">
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-2">
                        ...
                        <span class="text-gray-700 dark:text-gray-300">
                            <span class="font-bold text-purple-600 dark:text-purple-400" x-text="selectedAchievements.length"></span> prestasi dipilih
                        </span>
                    </div>
...
function skManagement() {
    return {
        ...
        get filteredAchievements() {
            if (!this.searchQuery) return this.achievements;
            
            const query = this.searchQuery.toLowerCase();
            return this.achievements.filter(a => {
                return a.student.nim.toLowerCase().includes(query) ||
        ...
        async openAssignModal(skId, skNumber, skTitle) {
            ...
            try {
                const response = await fetch(`/admin/sk/${skId}/achievements`);
