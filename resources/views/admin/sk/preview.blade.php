    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="mb-6">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Preview Surat Keputusan</h1>
                ...
                <div class="flex gap-2">
                    @if($sk->file_path)
                        <a href="{{ Storage::url($sk->file_path) }}" target="_blank"
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 mb-6">
            <h2 class="text-xl font-semibold text-gray-900 dark:text-white mb-4">Informasi SK</h2>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Nomor SK</label>
                    <p class="text-gray-900 dark:text-white">{{ $sk->sk_number }}</p>
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Tanggal SK</label>
                    <p class="text-gray-900 dark:text-white">{{ $sk->sk_date->format('d F Y') }}</p>
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Periode Akademik</label>
                    <p class="text-gray-900 dark:text-white">{{ $sk->academicPeriod->name ?? '-' }}</p>
                </div>
                <div>
                ...
                @if($sk->description)
                    <div class="md:col-span-2">
                        ...
                        <p class="text-gray-900 dark:text-white">{{ $sk->description }}</p>
                    </div>
                @endif
                @if($sk->file_path)
                    <div class="md:col-span-2">
        ...
        <!-- Statistics Card -->
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 mb-6">
            <h2 class="text-xl font-semibold text-gray-900 dark:text-white mb-4">Statistik Prestasi</h2>
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div class="bg-green-50 rounded-lg p-4">
                    ...
                    <div class="text-2xl font-bold text-green-900">
                        {{ $sk->assignments->pluck('achievement.student_id')->unique()->count() }}</div>
                </div>
                ...
                <div class="bg-orange-50 rounded-lg p-4">
                    ...
                    <div class="text-2xl font-bold text-orange-900">
                        {{ $sk->assignments->pluck('achievement.student.faculty')->unique()->count() }}</div>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                <h2 class="text-xl font-semibold text-gray-900 dark:text-white">Daftar Prestasi yang Terdaftar</h2>
                <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
            ...
            <div class="mt-6 bg-white rounded-lg shadow-md overflow-hidden">
                ...
                <div class="p-6">
                    <div class="aspect-[8.5/11] bg-gray-100 rounded-lg overflow-hidden">
                        <iframe src="{{ Storage::url($sk->file_path) }}" class="w-full h-full" frameborder="0">
                        </iframe>
                    </div>
