        ...
        <table class="w-full text-sm">
            <thead class="bg-gray-50 dark:bg-gray-700/50">
                <tr>
                    ...
                    <th class="px-4 py-3 text-left text-gray-600 dark:text-gray-300 font-medium">Event & Kategori</th>
                    ...
                    <th class="px-4 py-3 text-left text-gray-600 dark:text-gray-300 font-medium">Diajukan Oleh</th>
            ...
            <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                ...
                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/30">
                    ...
                    <td class="px-4 py-3">
                        @if($a->submitted_by === 'validator')
                        <span class="px-2.5 py-1 rounded-full text-xs font-medium bg-blue-100 text-blue-700 dark:bg-blue-900/30 dark:text-blue-400">Validator</span>
                        @else
                        <span class="px-2.5 py-1 rounded-full text-xs font-medium bg-purple-100 text-purple-700 dark:bg-purple-900/30 dark:text-purple-400">Mahasiswa</span>
                        @endif
                    </td>
                    <td class="px-4 py-3">
                ...
                @empty
                <tr><td colspan="8" class="px-4 py-8 text-center text-gray-500 dark:text-gray-400">Belum ada data.</td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
