        ...
        <div class="space-y-6">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6">
                ...
                <div class="space-y-3">
                    ...
                    @if($achievement->validation_status == 'appeal_submitted' && $achievement->latestAppeal)
                        <a href="{{ route('admin.appeals.show', $achievement->latestAppeal) }}" 
                           class="w-full px-4 py-2 bg-amber-600 hover:bg-amber-700 text-white rounded-lg font-medium transition-colors flex items-center justify-center gap-2">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
