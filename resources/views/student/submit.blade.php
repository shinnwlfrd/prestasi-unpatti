...
<div x-init="addFile()" x-cloak id="fileUploadSection">
                    ...
                    <p class="text-xs text-gray-500 dark:text-gray-400 mb-3">
                        Dokumen pertama adalah <strong>Sertifikat/Piagam</strong> (wajib). Anda bisa menambahkan dokumen pendukung lainnya.
                    </p>
                        ...
                        <template x-for="(fileItem, index) in files" :key="index">
                            <div class="border-2 border-gray-300 dark:border-gray-600 rounded-xl p-4 bg-white dark:bg-gray-800"
                                ...
                                <div x-show="index === 0" class="mb-2 flex items-center gap-2">
                                    <span class="px-2 py-1 bg-indigo-100 dark:bg-indigo-900/40 text-indigo-700 dark:text-indigo-300 text-xs font-semibold rounded-full">
                                        Dokumen Utama
                                    </span>
                                ...
                                <div class="flex items-start gap-3">
                                    <!-- Preview -->
                                    <div class="w-20 h-20 bg-gray-100 dark:bg-gray-700 rounded-lg flex items-center justify-center overflow-hidden flex-shrink-0 border-2 border-gray-200 dark:border-gray-600 relative group">
                                    ...
                                    <div class="flex-1 space-y-2">
                                        ...
                                        <!-- File Info -->
                                        <div x-show="fileItem.file" class="bg-gray-50 dark:bg-gray-900/50 rounded-lg p-2 border border-gray-200 dark:border-gray-700">
                                            <div class="flex items-start justify-between gap-2">
                                                <div class="flex-1 min-w-0">
                                                    <p class="text-sm font-medium text-gray-900 dark:text-white truncate" x-text="fileItem.fileName"></p>
                                                    <p class="text-xs text-gray-500 dark:text-gray-400" x-text="getFileSize(fileItem.file)"></p>
                                                </div>
                                        ...
                                        <input x-show="index === 0" type="hidden" :name="'document_types[' + index + ']'" value="certificate">
                                    </div>
                    ...
                    <p class="text-xs text-gray-500 dark:text-gray-400 mt-3 flex items-start gap-2">
                        ...
                        <span>Format: PDF, JPG, PNG. Ukuran maksimal: 5MB per file. Dokumen pertama (Sertifikat/Piagam) wajib diupload.</span>
                    </p>
                    @error('documents')
                        <p class="text-xs text-red-500 mt-1">{{ $message }}</p>
                    @enderror
