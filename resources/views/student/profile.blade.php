...
<div class="max-w-3xl mx-auto space-y-6 animate-fade-in">
            ...
            <div class="p-4 rounded-xl bg-gray-50 dark:bg-gray-700/50 border border-gray-200 dark:border-gray-600">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="font-bold text-2xl text-green-600 dark:text-green-400">{{ number_format($student->gpa ?? 0, 2) }}</p>
                    </div>
                </div>
            </div>
            <div class="p-4 rounded-xl bg-gray-50 dark:bg-gray-700/50 border border-gray-200 dark:border-gray-600">
    ...
    <x-card title="Statistik Prestasi">
        <div class="grid grid-cols-2 sm:grid-cols-4 gap-4">
            <div class="text-center p-4 rounded-xl bg-purple-50 dark:bg-purple-900/20 border border-purple-200 dark:border-purple-800">
