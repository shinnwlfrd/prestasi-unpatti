                ...
                <div x-show="!skipSk" class="p-4 bg-emerald-50 dark:bg-emerald-900/20 border border-emerald-200 dark:border-emerald-800 rounded-lg">
                    ...
                    <div class="relative">
                        <input type="file" name="sk_resmi" accept=".pdf,.jpg,.jpeg,.png"
                            ...
                            class="w-full border-emerald-300 dark:border-emerald-600 dark:bg-gray-700 dark:text-white rounded-lg file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-semibold file:bg-emerald-100 file:text-emerald-700 hover:file:bg-emerald-200 dark:file:bg-emerald-800 dark:file:text-emerald-200"
                            @change="
                                const file = $event.target.files[0];
                                if (file) {
                        ...
                        <div x-show="skFileName" class="mt-2 flex items-center justify-between">
                            ...
                            <button type="button" @click="showSkPreview = true"
                                class="inline-flex items-center gap-1 px-3 py-1 bg-emerald-600 hover:bg-emerald-700 text-white rounded-lg text-xs font-medium transition-colors">
                    ...
                    <p class="text-sm text-emerald-600 dark:text-emerald-400 mt-2">SK Resmi wajib diupload untuk approve prestasi</p>
                </div>
