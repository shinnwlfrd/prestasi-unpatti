...
<div class="max-w-7xl mx-auto" x-data="skManagement()">
    <div class="mb-6">
        ...
        <p class="text-gray-600 dark:text-gray-400 mt-1">Lihat daftar SK yang tersedia untuk approval prestasi</p>
    </div>
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="px-6 py-12 text-center">
                                ...
                                <p class="text-sm text-gray-400 dark:text-gray-500 mt-1">Hubungi admin untuk upload SK</p>
                            </td>
                        </tr>
                    @endforelse
                </tbody>
