            ...
            <form action="{{ route('validator.achievements.validate', $achievement) }}" method="POST">
                ...
                <x-card title="Checklist Validasi">
                    ...
                    <div class="flex gap-3 mt-6">
                        <button type="submit" name="action" value="approve" @click="selectedAction = 'approve'" 
                        ...
                        <button type="submit" name="action" value="reject" @click="selectedAction = 'reject'" 
                        ...
                        <button type="submit" name="action" value="request_revision" @click="selectedAction = 'request_revision'" 
