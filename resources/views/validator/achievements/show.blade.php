        ...
        <div @click.away="showApproveModal = false" 
            ...
            <div class="p-6 space-y-4">
                ...
                <div class="space-y-3">
                    ...
                    <!-- SK Preview -->
                    <div x-show="selectedSkId" x-cloak class="p-3 bg-emerald-50 dark:bg-emerald-900/20 border border-emerald-200 dark:border-emerald-800 rounded-lg">
                    ...
                    @if($skDocuments->isEmpty())
                        <div class="p-4 bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg">
                            <p class="text-sm text-yellow-800 dark:text-yellow-200">
                                ...
                                Belum ada SK yang tersedia. Silakan hubungi admin untuk upload SK terlebih dahulu.
                            </p>
                        </div>
                    @endif
                </div>
