...
<div class="space-y-6">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900 dark:text-white mt-1">{{ $statistics['approved_today'] ?? 0 }}</p>
                </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900 dark:text-white mt-1">{{ $statistics['revision_requested'] ?? 0 }}</p>
                </div>
    ...
    <!-- Filters -->
    <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6">
        <form method="GET" action="{{ route($routePrefix . '.pending.index') }}" class="grid grid-cols-1 md:grid-cols-4 gap-4">
            <!-- Search -->
            <div>
            ...
            <div>
                ...
                <select name="level" class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-transparent">
            ...
            <div>
                ...
                <select name="category" class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-transparent">
            ...
            <div class="flex items-end gap-2">
                ...
                <a href="{{ route($routePrefix . '.pending.index') }}" class="px-4 py-2 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
                    Reset
                </a>
            </div>
        </form>
                ...
                <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                        ...
                        <td class="px-6 py-4">
                            ...
                            <div class="text-sm text-gray-500 dark:text-gray-400">{{ $achievement->achievement?->category?->name }}</div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                    ...
                    <tr>
                        <td colspan="6" class="px-6 py-12 text-center">
                            ...
                            <p class="text-xs text-gray-400 dark:text-gray-500 mt-1">Semua prestasi sudah divalidasi atau belum ada yang diajukan</p>
                        </td>
                    </tr>
                    @endforelse
                </tbody>
